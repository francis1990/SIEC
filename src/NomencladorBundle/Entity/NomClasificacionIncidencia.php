...
/**
 * NomClasificacionIncidencia
 *
 * @ORM\Table(name="nom_clasificacion_incidencia")
 ...
 */
class NomClasificacionIncidencia
{
    /**
     * @var integer
     *
     ...
     *
     * @param string $codigo
     * @return NomClasificacionIncidencia
     */
    ...
    {
        return ' la clasificación de incidencia: ' . $this->nombre;
    }
}
