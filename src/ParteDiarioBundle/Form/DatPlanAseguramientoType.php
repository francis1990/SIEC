...
class DatPlanAseguramientoType extends AbstractType
{
    /**
    ...
    {
        $aseguramientos = $options['aseguramientos'];
        $builder
            ...
            ->add('idaseguramiento', "entity", array(
                'label' => 'Aseguramiento:',
                'placeholder' => 'Seleccione...',
                ...
                'choice_attr' => function ($aseguramiento) {
                    $data = '';
                    if ($aseguramiento->getIdunidadmedida() != null)
                        $data = $aseguramiento->getIdunidadmedida()->getIdunidadmedida();
                    return array('data-um' => $data
                    );
                },
                'choices'=>$aseguramientos
                ))
            ...
            ->add('cantidad', 'Symfony\Component\Form\Extension\Core\Type\NumberType', array(
                ...
                'attr' => array('placeholder' => '', 'class' => 'form-control mayorcero number  focus'),
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ParteDiarioBundle\Entity\DatPlanAseguramiento',
            'aseguramientos' => null
        ));
    }
}
