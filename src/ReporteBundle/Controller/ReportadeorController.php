 ...
 */
class ReportadeorController extends Controller
{
    /**
     * @Route("/reportadeor/",name="reportadeor_index")
     */
    public function indexAction()
    {
        ...
        return $this->render('ReporteBundle:Default/reportadeor.html.twig', array(
        ));
    }
