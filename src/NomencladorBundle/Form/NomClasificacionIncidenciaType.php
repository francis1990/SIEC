...
class NomClasificacionIncidenciaType extends AbstractType
{
    /**
        ...
        $builder
            ...
            ->add('aceptar', 'Symfony\Component\Form\Extension\Core\Type\SubmitType', array(
                ...
                'attr' => array(
                    ...
                    'id' => 'btn_addclasificacionincidencia',
                ),
            ));
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'NomencladorBundle\Entity\NomClasificacionIncidencia'
        ));
    }
}
